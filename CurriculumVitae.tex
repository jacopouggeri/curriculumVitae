...
{\sl DeepLearn Summer School} \\ 4th International School on Deep Learning \hfill 2021 \\ See \href{https://github.com/jacopouggeri/curriculumVitae/blob/84ad9712112b11ea237b126a98ba1764b27054b4/attachments/deeplearn.pdf}{Attachment}
\begin{itemize}
...
{\sl Building an MRPC muon detector chamber at CERN } \hfill 2017 \\ See \href{https://github.com/jacopouggeri/curriculumVitae/blob/84ad9712112b11ea237b126a98ba1764b27054b4/attachments/eee.pdf}{Attachment}
\begin{itemize}
...
\subsection*{Coding}
\begin{itemize}
\item Python, Java \hfill Extensiv Work
\item Javascript, C++ and Ruby \hfill Known
\item Data science and machine learning: PyTorch, Keras, OpenCV
\end{itemize}
...
\item Spanish \hfill B1 DELE certification
\item Japanese \hfill Passed Level 4 Class at Imperial College London
\item Mandarin \hfill Conversational
\end{itemize}
...
\includepdf[pages=-,pagecommand={\thispagestyle{plain}\label{attachment:grottini}},scale=0.8]{attachments/grottini.pdf}

\includepdf[pages=-,pagecommand={\thispagestyle{plain}\label{attachment:deeplearn}},scale=0.8]{attachments/deeplearn.pdf}

\includepdf[pages=-,pagecommand={\thispagestyle{plain}\label{attachment:eee}},scale=0.8]{attachments/eee.pdf}
